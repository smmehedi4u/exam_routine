        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input required value="{{ old('exam_year') }}" type="text" name="exam_year"
                ...
                <div class="form-group">
                    ...
                    <select required name="exam_type" class="form-control">
                        ...
                        <option @if (old('exam_type') == '1') selected @endif value="1">CT</option>
                        <option @if (old('exam_type') == '2') selected @endif value="2">Semester Final</option>
                    </select>
                    @error('exam_year')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <label>Course</label>
                            <select required multiple="" name="course[0][]" class="form-control course select2">

                                @foreach ($subjects as $subject)
                                    <option value="{{ $subject->id }}">{{ $subject->course_code }}</option>
                                @endforeach
                            </select>
                            @error('course')
                                <div class="text-danger">{{ $message }}</div>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <select required name="supervisor[0][]" multiple="" class="form-control select2">
        ...
        function add(){
            ...
            $(".extra").append(`<div class="row">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        <label>Course</label>
                        <select required name="course[`+count+`][]" multiple="" class="form-control course select2">
                            @foreach ($subjects as $subject)
                            <option value="{{ $subject->id }}">{{ $subject->course_code }}</option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        <label>Supervisor</label>
                        <select required name="supervisor[`+count+`][]" multiple="" class="form-control select2">
                            @foreach ($teachers as $teacher)
                            <option value="{{ $teacher->id }}">{{ $teacher->name }}</option>
                        @endforeach
                        </select>
